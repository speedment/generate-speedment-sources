 ...
 * @since  3.0.13
 */
public final class ToDoubleCollectorPattern extends AbstractPattern {

    public ToDoubleCollectorPattern(java.lang.Class<?> wrapper,
    ...
    public String getClassName() {
        return ucPrimitive() + "ToDoubleCollector";
    }
    ...
    public ClassOrInterface<?> make(File file) {
        ...
        return Interface.of(getClassName())
            ...
            .set(Javadoc.of(formatJavadoc(
                    ...
                    "values, resulting in a single {@code double}."
                ))
            ...
            .add(Method.of("finisher", SimpleParameterizedType.create(
                    SimpleType.create("com.speedment.common.function.ToDoubleFunction"),
                    SimpleType.create("A")
                ))
                .set(Javadoc.of(formatJavadoc(
